!function() {
    ...
    }(), d3.json("/Users/jennabaughman/Documents/berkeley/ds421/nasa/UCB_DS421_NEX_partnerProject/rotate/world-110m.json",
     function(t, n) {
     
        d3.selectAll("svg").insert("path", ".foreground").datum(topojson.feature(n, n.objects.land))
        .attr("class", "land"), d3.selectAll("svg").insert("path", ".foreground").
		...
		/* .data(data).enter()*/
		 ...
		 type: "Point",
		 coordinates: [87.6298-180,41.8781]
